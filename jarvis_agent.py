...
class JarvisAgent:
    ...
    def __init__(self,
        ...
        self.client = None
        if genai and self.api_key and self.api_key != "VOTRE_CLE_ICI":
    ...
    def system_prompt(self) -> str:
        base = (
            "Tu es JARVIS, assistant IA personnel cree par Tom.\n"
    ...
    def generate_response(self, user_message: str) -> str:
        if not self.client or not types:
            raise RuntimeError("Gemini n'est pas configure. Renseignez GEMINI_API_KEY dans .env.")
